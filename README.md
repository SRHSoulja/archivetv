...
> - **User-Created Channels**: Channels, tapes and commercial reels built with Channel Studio are assembled by the end-user, in their own browser, from items they select on archive.org themselves. The screening described above applies to the default dial; selections made beyond it are the user's own, and the public domain, Creative Commons and open access collections are the recommended ground.
